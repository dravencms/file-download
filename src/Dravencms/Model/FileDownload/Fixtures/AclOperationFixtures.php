...
class AclOperationFixtures extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        $operations = [
            'fileDownload' => [
                'edit' => 'Umožnuje editaci download',
                'delete' => 'Umožnuje smazání download'
            ]
        ];
    ...
    {
        return ['Dravencms\Model\FileDownload\Fixtures\AclResourceFixtures', 'Dravencms\Model\User\Fixtures\GroupFixtures'];
    }
}